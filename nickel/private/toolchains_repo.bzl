...
# By default all these toolchains are registered by the nickel_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:nickel_toolchain",
    toolchain_type = "@org_nickel_lang_rules_nickel//nickel:toolchain_type",
)
""".format(
            platform = platform,
